...
// Исправленный метод CalculateDirectionTowards в классе HexGrid
public int CalculateDirectionTowards(Vector3Int from, Vector3Int to)
{
    ...
    // Если не удалось определить направление, возвращаем направление восток (по умолчанию)
    return 0;
}
